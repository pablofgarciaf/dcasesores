      ...
      <aside className="w-64 bg-slate-900 border-r border-slate-800 p-6 flex flex-col h-screen sticky top-0">
         ...
         <nav className="space-y-2 flex-1">
            ...
            <button 
              ...
              className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl font-bold text-sm transition-colors ${activeTab === 'crm' ? 'bg-[#e11b22] text-white' : 'hover:bg-slate-800 text-slate-400'}`}
            >
