...
export function Navbar() {
  ...
  return (
    <header className="w-full sticky top-0 z-50 transition-colors">
      ...
      {/* 🔴 1. TOP BAR CORPORATIVO (IDÉNTICO AL SITIO OFICIAL DC ASESORES) */}
      <div className="w-full bg-slate-950 text-slate-300 text-xs border-b border-slate-800/80 hidden sm:block">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-10 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4 text-slate-400">
            <a 
              ...
              className="hover:text-[#e11b22] transition-colors"
            >
