...
export function Navbar() {
  ...
  return (
    <header className="w-full sticky top-0 z-50 transition-colors">
      ...
      <div 
        className={`w-full bg-slate-950 dark:bg-white text-slate-300 dark:text-slate-900 text-xs border-b border-slate-800/80 dark:border-slate-200 hidden sm:block transition-all duration-300 overflow-hidden ${
        ...
        <div className={`max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between transition-all duration-300 ${scrolled ? 'h-0 opacity-0' : 'h-10 opacity-100'}`}>
          ...
          <div className="flex items-center gap-2.5">
            <a 
              ...
              className="p-1.5 rounded-lg bg-white/10 dark:bg-slate-100 hover:bg-[#e11b22] dark:hover:bg-[#e11b22] text-white dark:text-slate-800 hover:text-white dark:hover:text-white transition-all flex items-center justify-center shadow-2xs active:scale-95"
            >
          ...
          <div className="flex items-center gap-6 text-slate-300 dark:text-slate-800 font-medium">
      ...
      <div className="w-full bg-white/95 dark:bg-slate-950/90 backdrop-blur-xl border-b border-slate-200/80 dark:border-slate-800 transition-colors shadow-xs">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center h-20">
          ...
          {/* Logo dual: modo claro (letras oscuras) vs modo oscuro (letras blancas) */}
          <Link href="/" onClick={closeMobileMenu} className="flex items-center gap-3 group">
            {/* Modo Claro: logo con letras oscuras */}
            <img 
            ...
            />
            {/* Modo Oscuro: logo con letras blancas */}
            <img 
          ...
          <div className="pt-2 flex flex-col gap-3">
            ...
            <div className="pt-2 flex items-center justify-center gap-4">
              <a 
                ...
                rel="noreferrer" 
                aria-label="Facebook DC Asesores"
                className="p-2 rounded-xl bg-slate-100 dark:bg-slate-800 text-slate-800 dark:text-white hover:bg-[#e11b22] dark:hover:bg-[#e11b22] hover:text-white dark:hover:text-white transition-all shadow-xs active:scale-95"
              >
