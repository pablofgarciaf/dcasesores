            ...
            <div className="pt-1">
              ...
              <div className="flex items-center gap-3">
                <a 
                  ...
                  className="w-9 h-9 rounded-xl bg-white/15 hover:bg-[#e11b22] text-white hover:text-white border border-white/20 transition-all flex items-center justify-center active:scale-95 shadow-xs"
                >
