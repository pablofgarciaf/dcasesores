...
export const INITIAL_INSURERS: Insurer[] = [
  ...
  },
  {
    ...
    rateRules: [
      ...
      { id: 'vaz-2', minVA: 15000.01, maxVA: 19999.99, rate: 4.30, rcLimit: 20000 },
      { id: 'vaz-3', minVA: 20000, maxVA: 24999.99, rate: 3.80, rcLimit: 20000 },
      { id: 'vaz-4', minVA: 25000, maxVA: 29999.99, rate: 2.60, rcLimit: 20000 },
      { id: 'vaz-5', minVA: 30000, maxVA: 34999.99, rate: 2.40, rcLimit: 20000 },
      { id: 'vaz-6', minVA: 35000, maxVA: 69999.99, rate: 2.20, rcLimit: 20000 },
      { id: 'vaz-7', minVA: 70000, maxVA: 999999, rate: 2.00, rcLimit: 20000 },
    ],
    updatedAt: new Date().toISOString(),
  },
  {
